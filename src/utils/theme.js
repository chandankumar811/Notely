...
export const getThemeClasses = (darkMode) => ({
    ...
    chatHeader: darkMode ? 'bg-gray-800 border-gray-700 text-gray-400' : 'bg-gray-100 border-gray-200 text-gray-600',
    noteHeader: darkMode ? 'bg-gray-800 border-gray-700 text-gray-400' : 'bg-gray-100 border-gray-200 text-gray-600',
    ...
    item: darkMode ? 'bg-gray-900 hover:bg-gray-800': 'bg-white hover:bg-gray-300',
    chatContactActive: darkMode ? 'bg-gray-700' : 'bg-gray-200',
    messageInput: darkMode ? 'bg-gray-700 text-white' : 'bg-gray-200 text-gray-800',
    ...
    mobileNavBar: darkMode ? 'bg-white border-gray-700' : 'bg-gray-900 border-gray-200 text-gray-300',
